...
import prettyPlease.cards.AbstractEasyCard;
import prettyPlease.cards.cardvars.SecondDamage;
import prettyPlease.cards.cardvars.SecondMagicNumber;
import prettyPlease.relics.AbstractEasyRelic;

import java.nio.charset.StandardCharsets;

@SuppressWarnings({"unused", "WeakerAccess"})
@SpireInitializer
public class PrettyPlease implements
        EditCardsSubscriber,
    ...
    public static final String modID = "PrettyPlease";
    ...
    public static void initialize() {
        PrettyPlease thismod = new PrettyPlease();
    }
